...
//!
//! this pallet allow setting up multiple smart contract address to be delegated by other substrate-pallets
//! the expected usage would be, using the scheduler to call airdropping methods within solidity
//!
